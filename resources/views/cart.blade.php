                            ...
                            @foreach (Cart::content() as $pdt)
                                <tr class="cart_item">
                                    <td class="product-remove">
                                        <a href="{{ route('product.remove', ['id' => $pdt->rowId]) }}" class="product-del remove" title="Remove this item">
                                    ...
                                    <td class="product-thumbnail">
                                        ...
                                        <div class="cart-product__item">
                                            <img src="{{ asset($pdt->model->image) }}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" width="100px" height="100px">
                                            <a href="{{ route('product.single', ['id' => $pdt->id]) }}">
                                    ...
                                    <td class="product-quantity">
                                        ...
                                        <div class="quantity">
                                            <a href="{{ route('product.decr', ['id' => $pdt->rowId, 'qty' => $pdt->qty]) }}" class="quantity-minus">-</a>
                                            <input title="Qty" class="email input-text qty text" type="text" placeholder="1" readonly value="{{ $pdt->qty }}">
                                            <a href="{{ route('product.incr', ['id' => $pdt->rowId, 'qty' => $pdt->qty]) }}" class="quantity-plus">+</a>
                                        </div>
